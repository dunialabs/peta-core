...
- `authConf` (array, required for Template): Authentication configuration array
  ...
  - **How to decide input vs OAuth**:
    ...
    - `ServerAuthType` reference: `1=ApiKey`, `2=GoogleAuth`, `3=NotionAuth`, `4=FigmaAuth`, `5=GoogleCalendarAuth`, `6=GithubAuth`, `7=ZendeskAuth`, `8=CanvasAuth`, `9=CanvaAuth`, `10=GmailAuth`, `11=GoogleDocsAuth`, `12=GoogleSheetsAuth`, `13=GoogleFormsAuth`.
